...
const resolveTimeSeriesYDomain = (
  data: Record<string, unknown>[],
  dataKeys: string[],
...
export const isClipExcludedComponent = (child: ReactElement): boolean => {
...
const ensureChildKey = (child: ReactElement, index: number): ReactElement => {
...
const TimeSeriesChartCore = memo(
  ({
    width,
    height,
    data,
    ...
    const columnWidth = useMemo(() => {
      const slotCount =
        xDomain && xDomainSlotCount !== null && xDomainSlotCount !== undefined
          ? xDomainSlotCount
...
export const TimeSeriesChartInner = (props: TimeSeriesChartInnerProps) => {
