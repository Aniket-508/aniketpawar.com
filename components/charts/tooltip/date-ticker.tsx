...
const DateTickerCompact = memo(
  ({ currentIndex, labels }: Omit<DateTickerProps, "visible">) => {
...
const DateTickerInner = memo(
  ({ currentIndex, labels }: Omit<DateTickerProps, "visible">) => {
    ...
    const monthSegments = useMemo(() => {
      ...
      for (let index = 0; index < parsedLabels.length; index += 1) {
