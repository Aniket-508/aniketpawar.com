...
import { getSvgPathFromStroke } from "@/components/signature-pad/helper";
import { Point } from "@/components/signature-pad/point";
...
const SignaturePad = ({ className, onChange }: SignaturePadProps) => {
  ...
  return (
    <div className="relative block">
      ...
      <div className="absolute right-4 bottom-4 flex gap-2">
        <button
          className="text-muted-foreground/60 hover:text-muted-foreground rounded-full p-0 text-xs focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
